        ...
        <div class="row">
          <div class="left-item col c-8">
            ...
            <video controls="" autoplay="" name="media">
              <source :src="episode_movie.link" type="video/mp4" />
            </video>
            <div class="content">
              <h4 class="title">
                {{ movie.name }}
...
export default {
  ...
  computed: {
    movie() {
      return this.$store.getters.getMovieBySlug(this.$route.path.split('/')[2])
    },
  },
  mounted() {
    this.getEpisode()
  ...
  methods: {
    getEpisode() {
      ...
      this.episode_movie = this.movie.episode.find((item) => item.slug === slug)
    },
  },
}
</script>
